...
Invoke-WebRequest -Uri https://dl.k8s.io/release/v1.25.0/bin/windows/amd64/kubectl.exe -OutFile "C:\Users\sqladmin\kubectl.exe"; Start-Process -FilePath "kubectl.exe" -WorkingDirectory "C:\Users\sqladmin\"
